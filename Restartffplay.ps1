...
$arg = "-fflags nobuffer -analyzeduration 500000 -f lavfi -i `"amovie='udp\:\/\/224.1.1.1\:10001',showvolume=f=0:w=720:dm=1:h=10:s=1:p=1`" -top 405 -left 1200 -alwaysontop -noborder -hide_banner"
